...
class ChunkGroupNode(NamedChildrenNode):
    ...
    def containsChunkNode(self, chunkPos):
        cx, cz = chunkPos
    ...
    def getChunkNode(self, chunkPos):
        cx, cz = chunkPos
    ...
    def chunkPositions(self):
        for area in self._children.values():
    ...
    def setLayerVisible(self, layerName, visible):
        for area in self._children.values():
            for chunkNode in area._children.values():
